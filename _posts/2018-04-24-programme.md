...
* lundi 2 juillet 2018, après-midi : 
  * [**Introduction to Bro Network Security Monitor**](#wsbro) <br />
  by **Eva Szilagyi** (CEO at Alzette Information Security) and **David Szili** (CTO at Alzette Information Security) - ([slides](/files/talks/workshop01-bro.pdf), [VM](https://drive.google.com/open?id=1txnJ-rWuPZmhISZJIzADyv4K9XdsMNeI))
...
* 09:00 - 09:35: [**Traffic filtering at scale on Linux**](#traffic) <br />
  by **François Serman** (OVH) - [(slides)](/files/talks/07-traffic-filtering-at-scale.pdf)
...
* 10:30 - 11:05: [**KEYNOTE: a 10 years journey in Linux firewalling**](#netfilter) <br />
  by **Pablo Neira Ayuso** (Head of Netfilter core team) - [(slides)](/files/talks/09-keynote-linux-firewalling.pdf)
...
* 11:40 - 12:15: [**Rumps session**](#rumps)<br />
  **Story behind our conference** by **Christophe Brocas** - [(slides)](/files/talks/rump00-story-behind-our-conference.pdf)
  ...
  <br>**Let's talk about curl** by **Yoann Lamouroux** - [(slides)](/files/talks/rump02-curl.pdf)
  <br>**Secured distributed storage and sharing** by **Julien Peeters** - [(slides)](/files/talks/rump03-trusted-storage.pdf)
  <br>**ops vs secu : how it work** by **Camille Raynaud-Coco** - [(slides)](/files/talks/rump04-ops-vs-secu.pdf)
...
* 14:15 - 14:50: [**Security and Self-Driving Computers**](#modmd) <br />
  by **Stefan Eissing** (Mod_md developer (Let's Encrypt Apache module)) - (slides: [.pdf](/files/talks/11-mod-md.pdf)/[remark](/files/talks/11-mod-md-remark.tgz))
...
* 09:00 - 09:35: [**Fail frequently to avoid disaster, or how to organically build an open threat intelligence sharing standard to keep the intelligence community free and sane!**](#fail) <br />
  by **Alexandre Dulaunoy** (CIRCL) & **Andras Iklody** (CIRCL) - [(slides)](/files/talks/18-misp.pdf)
* 09:35 - 10:10: [**The story of Greendale**](#greendale) <br />
  by **Thomas Chopitea** (Forensics investigator and engineer, Google) - [(slides)](/files/talks/19-greendale.pdf)
<div style="padding-left:40px"><div style="text-align: center; font-weight: bold">~~~ morning pause ~~~</div></div>
...
* 10:30 - 11:05: [**Internals of Landlock: a new kind of Linux Security Module leveraging eBPF**](#landlock) <br />
  by **Mickaël Salaün** (Security researcher, ANSSI) - [(slides)](/files/talks/20-landlock.pdf)
* 11:05 - 11:40: [**Secure programming is slow - really?**](#securityisslow) <br />
  by **Pierre Chifflier** (Long time FLOSS developer, ANSSI) - [(slides)](/files/talks/21-security-perf.pdf)
...
* 15:25 - 16:00: [**Expl-iot: IoT Security Testing Framework**](#expliot)<br />
  by **Aseem Jakhar** (R&D director and open source developer, Payatu software lab) - [(slides)](/files/talks/25-expliot.pdf)<br />
<div style="padding-left:40px"><div style="text-align: center; font-weight: bold">~~~ afternoon pause ~~~</div></div>
...
* 16:20 - 16:40: [**Freedom Fighting Mode - Open Source Hacking Harness**](#harness)<br />
  by **Ivan Kwiatkowski** (Pentester and malware analyst) - (slides: [.odp](/files/talks/26-freedom-fighting-mode.odp)/[.pptx](/files/talks/26-freedom-fighting-mode.odp)) <br />
* 16:40 - 17:00: [**Open Hardware for (software) offensive security**](#openhardware)<br />
  by **Antoine Cervoise** (IT security engineer, NTT Security) - [(slides)](/files/talks/27-open-hw-for-offensive-security.pdf)
* 17:00 - 17:20: [**Shadow on the Wall -  Risks and Flaws with Shadowsocks**](#shadowsocks)<br />
  by **Niklas Abel** (Pentester and security auditor, X41) - [(slides)](/files/talks/28-shadowsocks.pdf)
* 17:20 - 17:40: [**Glassfish from (IN)Secure admin**](#glassfish)<br />
  by **Jérémy Mousset** (Pentester) - [(slides)](/files/talks/29-glassfish.pdf)
...
<strong>Requirements for the workshop:</strong>
<ul>
...
<a href="https://github.com/nbs-system/snuffleupagus">https://github.com/nbs-system/snuffleupagus</a>
<br /><br />
...
This talk is intended to be a deep dive into some internals of [Landlock](https://landlock.io). For a more general introduction to Landlock, you can get a look at https://landlock.io (FOSDEM 2018).
<br /><br />
