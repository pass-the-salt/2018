...
**Videos and slides :**
* **videos** are available on the [Pass the SALT channel of the Ubicast TV website](https://passthesalt.ubicast.tv/channels/#2018),
* **slides** are located [there](https://2018.pass-the-salt.org/files/talks/).

And now, **enjoy the following schedule of workshops and talks** and come to share knowledge and collaborate.

**Program available through the Android generic conf planner application, Giggity:**
* install Giggity from the [Playstore](https://play.google.com/store/apps/details?id=net.gaast.giggity&hl=en) or from [F-Droid](https://f-droid.org/en/packages/net.gaast.giggity/)
* add the program URL ([+] > add URL): 
[https://2018.pass-the-salt.org/files/schedule.xml](https://2018.pass-the-salt.org/files/schedule.xml) 

Also available without any application needed: the [PDF version](https://2018.pass-the-salt.org/files/schedule.pdf). 
