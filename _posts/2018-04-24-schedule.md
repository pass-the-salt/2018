...
The Pass the SALT (Security And Libre Talks) schedule is now **published**. We are very proud about the trust that all the submitters to our Call for Papers put in this first edition of PTS. We want to thank all of them and we will try to do our best to deserve this trust. And now, just enjoy this schedule and come to **share knowledge and collaborate**. 
...
* 15:25 - 15:45: [**Vulture**: Preview of Vulture's upcoming web filtering engine](#vulture) <br />
...
* 16:25 - 17:00: [**LemonLDAP::NG:** Second factor authentication (2FA)](#lemonldap)<br />
  by **Clément Oudot** (LemonLDAP::NG developer) and **Xavier Guimard** (LemonLDAP::NG creator and developer) <br />
* 17:00 - 17:35: [**[Yet to Be Confirmed] No way JOSE!** Lessons for authors and implementers of open standards](#jose)<br />
  by **Fraser Tweedale** (Haskel Jose library maintainer, Redhat)
* 17:35 - 17:55: [**FreeIPA**](#freeipa)<br />
...
* 11:05 - 11:40: [**Secure programming are slow - really ?**](#securityisslow) <br />
...
<br />
<i>Antide Petit is an infosec student. In 2017, he has done a GSoC on Cutter and is currently its maintainer.</i>
...
In this talk, we focus on networking. We will go in depth into BPF bytecode, the available toolchains and API and follow the path of packets from the NIC to a user space application and see how eBPF can be leveraged to perform traffic filterin: from socket filtering API, to tc qdisc filtering, to finally (hopefully) explore XDP capabilities.
<br /><br />
<strong>Francois Serman (OVH)</strong>
<br />
<i> I filter large numbers of packets and automate things.</i>

<a name="ebpfxdp"></a>
<div style="border-left: 5px solid #7b4397;  border-top: 1px solid #7b4397; color: #dc2430; ; padding-left: 10px"> <h3><strong>Performance with a S like Security: the eBPF XDP case</strong></h3></div>
...
Note from org@: just come :)
<br /><br />
<strong>Pablo Neira Ayuso</strong>
<br />
<i>Also from org@: Pablo has been the netfilter lead for the last ten years. Period. ;) </i>
...
<br />
<i>Stefan Eissing is one of the founders of greenbytes, a small software consultancy company in Germany with customers such as Adobe, SAP, Google and Deutsche Telekom. And very active in the IETF http working group and related areas. Personally, he has obsessed about computers forever - it seems - and sees no reason for stopping. In 2015 he became part of the Apache httpd project after he did the HTTP/2 implementation for the server.</i>
...
<br /><br />
<strong>Julien 'jvoisin' Voisin (nbs system), Thibault 'bui' koechlin (nbs system), Simon 'piké' MAGNIN-FEYSOT (nbs system)</strong>
<br />
<i>Bios seem to have been dropped on the fly by the PHP protection module during their submission. Maybe a false positive. Or not.</i>
...
<br /><br />
<strong>Jérémie JOURDIN, Hugo SOSZYNSKI (aDvens)</strong>
<br />
<i>Bios seem to have been dropped on the fly by the WAF during their submission. Maybe a false positive. Or not.</i>
...
<br /><br />
<strong>François Poulain (APRIL)</strong>
<br />
<i>François Poulain is administrator and treasurer engaged for more than 10 years in the April NGO to promote and defend free software. He is at the origin of the amie.coop project aiming at satisfying the IT needs of small structures of solidarity economy. He is involved in the SecureDrop community for server maintenance.</i>
<br /><br />
<strong>Loic Dachary (SecureDrop)</strong>
<br />
<i>Loïc is a Securedrop developer.</i>
...
In LemonLDAP::NG 2.0, the second factor authentication is now a built-in feature and allows to rely on FIDO Alliance, TOTP, Yubikey, or any third party device trough script call. I will first present how authentication works in LL::NG and how the 2FA was integrated as core functionality.
<br /><br />
<strong>Clément OUDOT (Worteks)</strong>
<br />
<i>I work on Identity Management with free softwares like LemonLDAP::NG, OpenLDAP, LDAP Tool Box, LSC and Fusion Directory.</i>
<br /><br />
<strong>Xavier Guimard</strong>
<br />
<i>Creator and main developer of the Web SSO software, LemonLDAP::NG.</i>
...
<br /><br />
<strong>Fraser Tweedale (Red Hat)</strong>
<br />
<i>Fraser works at Red Hat on the FreeIPA identity management system and Dogtag Certificate System. He's interested in security, cryptography and functional programming. Jalapeño aficionado from the land Down Under.</i>

<a name="freeipa"></a>
<div style="border-left: 5px solid #7b4397;  border-top: 1px solid #7b4397; color: #dc2430; ; padding-left: 10px"> <h3><strong>FreeIPA</strong></h3></div>
...
<br /><br />
<strong>Florence Blanc-Renaud (Red Hat) </strong>
<br />
<i>Florence Blanc-Renaud is a Senior Software Engineer working at Red Hat on the FreeIPA Identity Management project.</i>
...
Note to reviewers: the slides are the ones given at FIRST conference in Prague but the content will be improved and more technical for the people at pass-the-salt (and a bit more oriented on the free  software aspect too).
<br /><br />
<strong>Alexandre Dulaunoy (CIRCL - Computer Incident Response Center Luxembourg) </strong>
<br />
...
<br /><br />
<strong>Andras Iklody (CIRCL - Computer Incident Response Center Luxembourg)</strong>
<br />
<i>Andras Iklody is a software developer working for CIRCL and has been the main developer of the Malware Information Sharing Platform since the beginning of 2013. He is a firm believer that there are no problems that cannot be tackled by building the right tool.</i>
...
<br /><br />
<strong>Thomas Chopitea (Google)</strong>
<br />
<i>Thomas Chopitea is a forensics investigator and engineer at Google. Previously, he worked at CERT Société Générale, where he bootstrapped the threat intelligence process using a combination of existing and homebrew open-source tools. He likes to write code and hunt down bad guys. His long-term professional goal is to automate himself out of a job.</i>
...
<br /><br />
<strong>Mickaël Salaün (ANSSI)</strong>
<br />
<i>Mickaël Salaün is a security researcher, software developer and open source enthusiast. He is mostly interested in Linux-based operating systems, especially from a security point of view. He has built security sandboxes (e.g. StemJail) before hacking into the kernel on a new LSM called Landlock. He is currently employed by the French Network and Information Security Agency (ANSSI).</i>

<a name="securityisslow"></a>
<div style="border-left: 5px solid #7b4397;  border-top: 1px solid #7b4397; color: #dc2430; ; padding-left: 10px"> <h3><strong>Secure programming are slow - really ?</strong></h3></div>
...
<br />
<i>Pierre Chifflier is the head of the intrusion detection research lab (LED) at ANSSI. He is interested in various security topics such as Operating Systems, compilers, programming languages, and new intrusion detection methods. He is also a Debian developer and has been involved in free software since a long time.</i>
...
<br /><br />
<strong>Geoffroy Couprie (Clever Cloud)</strong>
<br />
<i>Geoffroy handles security at Clever Cloud, develops in Rust and researches on parser security at VideoLAN. He thinks a lot about cryptography, protocol design and data management.</i>
...
This presentation will share to the audience the status of IOT attacks from a worldwide distributed honeypot point of view. What are the different protocols, their exposure to the internet and how they are being actively exploited (Modbus, IPMI, S7, Bacnet, Telnet, SNMP etc.)? We have created a Gas Station simulation, no latter than 3 hours after having the server on the internet, we started to monitor communications towards a fake S7 service (our Siemens PLC: Siemens SIMATIC S7-200). We are using free software only and this talk want to boost the audience with the understanding of those technologies and share experience on how to write such a type of honeypot, and hopefully have more ideas to improve the security of a domain that is at least 15 years late!
<br /><br />
<strong>Sebastien Tricaud (Splunk)</strong>
<br />
<i>I like open source and security, from being a former maintainer of Linux PAM to various contributions to tools such as Prelude IDS etc.</i>
...
The concept of “hacking harnesses” was introduced by <a href="https://conference.hitb.org/hitbsecconf2007kl/materials/D1T1%20-%20The%20Grugq%20-%20Meta%20Antiforensics%20-%20The%20HASH%20Hacking%20Harness.pdf">(thegrugq, 2007)</a>. Ever since, the subject has received virtually no attention and no such tool has been released publicly. Worse, the code that had been made available at the time is no longer online and was lost by its author. The goal of harnesses is to provide a hacking environment where security professionals can focus on red teaming activities without having to fight against their terminal to perform simple actions (such as uploading or downloading files, and executing remote commands in memory). FFM is a Python framework which was developed to fill this void. 
<br /><br />
<strong>Ivan Kwiatkowski (@JusticeRage)</strong>
<br />
<i>Ivan Kwiatkowski is an OSCP and OSCE-certified penetration tester and malware analyst living in France. His day to day job occasionally involves incident response and delivering trainings. He maintains Manalyze, an open-source dissection tool for Windows executables and his research was presented during several cybersecurity conferences in Europe. As a digital privacy activist, he also operates an exit node of the Tor network. Ivan unwittingly rose to internet fame as a vigilante hacker by talking tech support scammers into infecting themselves with ransomware.</i>
...
<br /><br />
<strong>Antoine Cervoise (NTT Security)</strong>
<br />
<i>Antoine is an IT security engineer, skilled in infosec incident handling, pentest and audit. He enjoys computer science, electronics and D.I.Y., beers (drinking and making) by night… and he’s fond of cigars!</i>
...
<br /><br />
<strong>Jeremy Mousset</strong>
<br />
<i>I'm a pentester and a Ron addict. I'm working at Vente-privee.com but this subject comes from my previous life of penetration tester in BT. I wrote an article on MISC regarding the JMX security in Tomcat and I'm currently interested by Glassfish.</i>